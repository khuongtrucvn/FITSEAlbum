...
public class CloudImageAdapter extends BaseAdapter {
    Context context;
    int layout;
    List<CloudImage> cloudImageList;

    public CloudImageAdapter(Context context, int layout, List<CloudImage> cloudImageList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(rowview==null){
            ...
            holder.txt=(TextView) rowview.findViewById(R.id.text_view_name);
            holder.img=(ImageView) rowview.findViewById(R.id.image_view_upload);
